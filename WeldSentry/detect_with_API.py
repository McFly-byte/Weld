# FILE: WeldSentry/detect_with_API
# USER: mcfly
# IDE: PyCharm
# CREATE TIME: 2024/10/9 9:11
# DESCRIPTION:
...
class simulation_opt:
    def __init__(self, weights='YOLOv7/weight/best.pt',
...
class detectapi:
    def __init__(self, weights, img_size=640):
        ...
        if self.classify:
            ...
            self.modelc.load_state_dict(torch.load('YOLOv7/weight/best.pt', map_location=self.device)['model']).to(
                self.device).eval()
